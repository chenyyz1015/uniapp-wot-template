...
src/static/ip/                         # IP 角色参考图
src/static/avatars/                    # 头像
src/static/icons/                      # 功能图标
src/static/illustrations/              # 空态/引导插图
src/static/sprites/                    # 精灵图
```
...
| 资源 | 路径 | 状态 |
|------|------|------|
| 空态插图 | src/static/illustrations/user-list-empty.png | ✅ 已生成 |
| 默认头像 | src/static/avatars/default-user.png | ✅ 已生成 |
| 新增图标 | src/static/icons/icon-add.png | ✅ 已生成 |
